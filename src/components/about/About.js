            ...
            <Grid container direction={'row'} spacing={3} justify={'center'}>
              ...
              <Grid item xs={12} sm={6} md={5}>
                ...
                <p>
                  ...
                  concentration in Interaction Design, at Northeastern University, as well as minors in Computer Science
                  and Art History. My goal is to create meaningful interactions and experiences that are accessible to
                  all. When I'm not designing or developing, you can find me reading a good book{' '}
                  <s>in Boston Commons</s>, watching (and sometimes re-watching) films <s>at the Coolidge or Brattle</s>
                  , playing Animal Crossing, or hanging with friends (via the internet right now!). Also, catch me
                  always wearing my trusty Dr. Marten sneakers!
                </p>
