            ...
            <Container>
              <Grid container justify={'center'}>
                ...
                <Grid item xs={12} sm={10} md={8}>
                  <h4>About</h4>
                  <p>
                    During my second semester at Scout, I worked with Mass Hike as a designer. Mass Hike is a non-profit
                    focused on making nature more accessible to Bostonians. Mass Hike runs trips to and from local
                    reservations and parks, and from there, customers are free to explore or go on a hike with the team
                    lead. Mass Hike targets two groups: young professionals and low-income community members. For
                    distinct reasons, these two groups have a difficult time making it out of the city. Mass Hike needed
                    a brand that matched its unique mission, a marketing website that captured the fun of nature, and a
                    ticket-purchasing system that was simple and easy to use.
                  </p>
                ...
                <Grid item xs={12} sm={10} md={8}>
                  ...
                  <p>
                    ...
                    were working professionals who lacked transportation to nature and members of low-income communities
                    who, due to financial constraints, struggle to make it out of the city. As a team of college
                    students, we felt that we had a good grasp on the needs and goals of young professionals, so we
                    decided to focus our research efforts on understanding how we could help lower-income community
                    members.
                  </p>
                  <p>
                    Mass Hike was able to share several contacts with us so we could talk to real-life users. One of the
                    people on their list helped organize events in low-income housing developments and loved Mass Hike’s
                    goal. I was able to set up a phone call and talk to her about how we could best design for the
                    low-income community. The most important questions were…
                  </p>
                  <ul>
                    <li>
                  ...
                  <p>
                    Through this interview, I was able to gather valuable insight. We learned that many people are using
                    public computers to access the internet and most use non-smart phones on a day-to-day basis. This
                    meant that as a team we needed to focus on the desktop experience, as opposed to the mobile one, as
                    the main target audience was primarily using computers. She also mentioned that people prefer paying
                    in cash if possible and that many community members do not have a bank account or credit card.
                  </p>
                </Grid>
                <Grid item xs={12}>
                  <blockquote>
                ...
                <Grid item xs={12} sm={10} md={8}>
                  ...
                  <p>
                    ...
                    solution work for Mass Hike, I needed to design a way for two people to meet in a designated place.
                    Through a previous connection with Boston Centers for Youth & Families, we were able to use their
                    locations as a meeting spot. From there, I designed a calendar system that allowed Mass Hike team
                    members to input when they were free and then a user could book that time and pick their nearest
                    Boston Centers for Youth & Families as the meeting place. This allowed users to pay in cash and for
                    Mass Hike to collect payment before the day of the trip.
                  </p>
                  <p>
                    On top of allowing users to pay in cash, we updated the ticket purchasing process to allow for promo
                    codes and pay-what-you-want tickets. Mass Hike offers $2.00 tickets to low-income families and with
                    our new system, Mass Hike could create a promo code and share it with the families that qualified.
                    The pay-what-you-want tickets allow users who may be able to pay extra to enter their ticket price
                    with the knowledge that they were helping subsidize the cost of tickets for low-income families.
                    These changes made the booking platform perfect for Mass Hike and its users.
                  </p>
                </Grid>
              </Grid>
            </Container>
            ...
            <Container>
              <Grid container justify={'center'}>
                <Grid item xs={12} sm={10} md={8}>
                  <h4>Reflection</h4>
                  <p>
                    Mass Hike was one of the most educational and valuable projects I have worked on to date. I grew SO
                    much in those four months and was able to work with an incredibly hard-working team. Looking back, I
                    wish my team and I were more cognizant of accessibility guidelines, and that is definitely the one
                    thing I would change about this project. I can’t go back in time and tweak colors and font styles,
                    but I can use this experience to learn how to do better!
                  </p>
                  <p>
                    ...
                    users are spending the most time. Though the continued success of Mass Hike speaks volumes, it would
                    be great to confirm that with numbers.
                  </p>
                  <p>
