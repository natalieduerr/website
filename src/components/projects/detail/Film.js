              ...
              <Grid container justify={'center'}>
                ...
                <Grid item xs={12} sm={10} md={8}>
                  ...
                  <p>
                    ...
                    the directors who have won Best Picture at the Oscar's (hint: it's been a white man 86 times out of
                    92 years), so it was a great way to tie together the concept of what critics and Hollywood deem to
                    be the best versus what a consumer spends time and money to watch.
                  </p>
                  <p>
                    Initially, my project started as more of a visualization of where I watched films and who was in
                    them. Though still interesting, I needed a focus to pull the poster together. From critical feedback
                    and reflection, I decided to look at the diversity of films I was watching, specifically racial and
                    gender diversity as that related to my first project. Below are two iterations of this poster and
                    the final one.
                  </p>
                </Grid>
              </Grid>
              ...
              <Grid container justify={'center'}>
                <Grid item xs={12} sm={10} md={8}>
                  ...
                  <p>
                    ...
                    make a more powerful statement. Personally I was able to see that while I do watch a good percentage
                    of films by women (women were directors of only 10.6% of the top movies in 2019, while 21.6% of the
                    films I watched were directed by women), I should find and support more directors of color.
                  </p>
                  <p>
