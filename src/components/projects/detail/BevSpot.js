              ...
              <Grid container justify={'center'}>
                ...
                <Grid item xs={12} sm={10} md={8}>
                  ...
                  <p>
                    ...
                    who love to provide feedback and their ideas so I was able to connect with them to hear what changes
                    they wanted to see in our ordering flow.{' '}
                  </p>
                  <p>
                    During these calls, it became very clear the biggest issue was ordering in different units (i.e. 750
                    ML vs 1L bottle) and having multiple vendors for one item (i.e. broccoli can be purchased from many
                    places). Our current product provided no solution for these problems so it was clear this would be a
                    good place to start.
                  </p>
                  <p>
                    From these chats and my own research, I created a user research report which I presented to the main
                    stakeholders to validate 1) the need for this update and 2) the scale of this project and its affect
                ...
                <Grid item xs={12} sm={10} md={8}>
                  ...
                  <p>
                    ...
                    whiteboarding ideas during Design Team meetings and just throwing out whatever we thought. Below is
                    an example of a whiteboard exercise we did for adding items from different vendors, like Sysco or
                    BevSpot's default catalog.
                  </p>
                  <img
                  ...
                  <p>
                    ...
                    users we initially spoke with. This provided a consistent stream of feedback to incorporate into my
                    work.
                  </p>
                </Grid>
              </Grid>
            ...
            <Container>
              <Grid container justify={'center'}>
                <Grid item xs={12} sm={10} md={8}>
                  <h4>Reflection</h4>
                  <p>
                    Though this product update was never launched, I learned so much about the process of providing new
                    updates to users. It is so easy to be on the user side and just think "Wow it would have been so
                    much better if the team did X over Y", but being on the product side showed how much thought,
                  ...
                  <ol>
                    ...
                    <li>
                      A decrease in the average number of items in a user's account (items like 750mL and 1L bottles of
                      the same product could now be combined to one item)
                    </li>
                    <li>
                      Users utilizing the Sysco catalog to place orders with Sysco through BevSpot (not possible in the
                      current product)
                    </li>
