            ...
            <Container>
              <Grid container justify={'center'}>
                ...
                <Grid item xs={12} sm={10} md={8}>
                  <h4>About</h4>
                  <p>
                    In August 2019, BevSpot was releasing a new and improved Drink Price Tool. To promote this release I
                    was tasked with designing and developing a new landing page. The landing page was expected to bring
                    in a lot of traffic from new and current users so it needed to be informative and encourage new
                    visitors to sign up for a free trial with BevSpot.
                  </p>
                ...
                <Grid item xs={12} sm={10} md={8}>
                  ...
                  <p>
                    Following the design trends of summer 2019, I incorporated wavy lines and colorful section dividers
                    to our landing page. Not only did these design concepts fit with the theme, but they were incredibly
                    popular and recognizable by the general public.
                  </p>
                  <p>
                    To not overwhelm the viewer, the page was divided into several distinct sections with clear actions.
                    Certain sections featured interactive elements that could provide the user with more information on
                    click. The main call to action to 'Sign Up for BevSpot' followed the user as they scrolled as well.
                    This meant that once they decided to give our product a try, they wouldn't have to look hard for the
                    next step.
                  </p>
                  <p>
              ...
              <Grid container justify={'center'}>
                ...
                <Grid item xs={12} sm={10} md={8}>
                  ...
                  <p>
                    I did not have access to any metrics related to this page, but to consider this project successful I
